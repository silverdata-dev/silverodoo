...
class LinkApWizard(models.TransientModel):
    ...
    _description = 'Agregar APs al Router'

    core_id = fields.Many2one('silver.core', string='Router', required=True, readonly=True, default=lambda self: self.env.context.get('active_id'))
