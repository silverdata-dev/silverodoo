...
class QueueLineSpeedChart extends Component {
    setup() {
    ...
    async updateData() {
        ...
        const result = await this.orm.call(
            "silver.netdev.queue.wizard.line",
            "get_interface_speed",
            [lineId]
        );
...
QueueLineSpeedChart.template = "silver_network.QueueLineSpeedChart";

registry.category("fields").add("queue_line_speed_chart", {
    component: QueueLineSpeedChart,
});
