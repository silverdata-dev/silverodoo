...
class QueueSpeedChart extends Component {
    setup() {
...
QueueSpeedChart.template = "silver_network.QueueSpeedChart";

registry.category("fields").add("queue_speed_chart", {
    component: QueueSpeedChart,
});