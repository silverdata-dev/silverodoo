...
class SilverOnuProfile(models.Model):
    ...
    product_ids = fields.One2many('product.template', 'onu_profile_id', string='Productos')
    #hardware_model_ids = fields.One2many('silver.hardware.model', 'onu_profile_id', string='Modelo')
